...
** Global variables
  ...
  (defcustom ers-packages '(use-package ag
                             ...
                             helm helm-ag helm-projectile ac-helm helm-descbinds
...
* Indentation settings
  ...
  #+begin_src emacs-lisp
    ...
    (defun ers/indentation-set-style ()
...
** Grails settings
  ...
  (use-package grails-projectile-mode
    :config (grails-projectile-global-mode t)
     ...
     (use-package helm
       ...
       (progn
         (setq helm-ff-transformer-show-only-basename nil
               ...
               helm-boring-file-regexp-list           '("\\.git$" "\\.gradle$" "\\.svn$")
