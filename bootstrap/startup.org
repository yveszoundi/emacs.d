...
#+begin_src emacs-lisp
  ...
  (defcustom ers-packages '(use-package ag
                             ...
                             htmlize undo-tree
                             projectile workgroups2 guide-key
                             powerline rainbow-delimiters
...
#+begin_src emacs-lisp
  ...
  (let ((my-bindings `((,(kbd "C-c <left>")  . windmove-left)
                       ...
                       (,(kbd "C-c o")       . occur))))
    (dolist (my-binding my-bindings)
      (global-set-key (car my-binding) (cdr my-binding))))
